...
plot(1:(n/2),abs(fft(Differenced_Data_Brazil)[2:(n/2+1)])^2/n,type ='h', main ='Spectral Estimate',ylab= 'Frequency' )
plot(1:(n/2),abs(fft(Differenced_Data_Rio)[2:(n/2+1)])^2/n,type ='h', main ='Spectral Estimate',ylab= 'Frequency' )
